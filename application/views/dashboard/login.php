...
<html lang="en">
    ...
    <body class="d-flex justify-content-center align-items-center flex-column text-center">
        <img class="my-3" src="<?php echo base_url(); ?>assest/img/ci.png" alt="" width="100" height="100">
        <p class="big text-center">Admin Panel in Codeigniter</p>
...
?>
            ...
            <form action="<?=base_url()?>welcome/signIn" method='POST'>
                <div class="bg-dark rounded-lg  col-md-12 p-4 text-light">
                    ...
                    <?=form_error('password')?>
                    <button class="btn btn-lg btn-outline-light btn-block mb-5" type="submit" value="signIn"
                        name="signIn">Sign in</button>
                    <!-- <p class="mt-5 mb-3 text-muted">&copy; 2017-2022</p> -->
                    <div>
                        <a class=" text-decoration-none text-light" href="<?=base_url() . 'welcome/signUp'?>">Don't
                            have account? SignUp
                        </a>
                    </div>
